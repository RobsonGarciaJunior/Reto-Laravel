...
class IncidencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('incidencies')->insert([
            ...
            'text' => 'Han habido varios problemas con esto relacionado a que existe un cliente de la empresa del cual no tenemos registrado su nueva dirección en el sistema. Nos mandaron un correo informando el cambio de local de su sucursal pero no ha sido actualizada para el departamento de Logística.',
            'estimatedTime' => 5,
            'categoryId' => 2,
            'departmentId' => 3,
            'userId' => 5,
